 ...
 */
 $messages['ar'] = array(
	'sphinxsearch'             => 'البحث في ويكي بواسطة برمجية سفينكس',
	'sphinxsearch-desc'        => 'استبدال محرك البحث ميدياويكي  بمحرك [http://www.sphinxsearch.com/ سفينكس]',
	'sphinxSearchInNamespaces' => 'ابحث في النطاقات:',
	'sphinxSearchInCategories' => 'ابحث في التصنيفات:',
	'sphinxExcludeCategories'  => 'عدم البحث في التصنيفات التالية:',
	'sphinxResultPage'         => 'صفحة النتائج:',
	'sphinxPreviousPage'       => 'السابق',
	'sphinxNextPage'           => 'التالي',
	'sphinxSearchPreamble'     => '{{PLURAL:$3|عرض النتيجة الوحيدة ا|عرض $1–$2 من $3 نتائج}} لسؤال "<nowiki>$4</nowiki>" في־{{PLURAL:$5|ثانية واحدة|$5 ثواني}}. إحصائيات:',
	'sphinxSearchStats'        => '* المتسلسلة "$1" عثر عليها {{PLURAL:$2|مرة واحدة|$2 مرّات}} في{{PLURAL:$3|وثيقة واحدة|$3 وثائق}}',
	'sphinxSearchStatsInfo'    => "''ثمّة احتمال بأن الأعداد أعلاه تشمل وثائق غير مدرجة بسبب خيارات أو تعريفات البحث.''",
	'sphinxSearchButton'       => 'بحث',
	'sphinxSearchEpilogue'     => 'مدّة قاعدة البيانات الإضافية كانت {{PLURAL:$1|ثانية واحدة |$1 ثوان}}.',
	'sphinxSearchDidYouMean'   => 'هل قصدتم:',
	'sphinxMatchAny'           => 'تطابق إحدى الكلمات',
	'sphinxMatchAll'           => 'تطابق جميع الكلمات',
	'sphinxMatchTitles'        => 'تطابق في العناوين فقط',
	'sphinxLoading'            => 'تحميل…',
	'sphinxPowered'            => ' مشغّل على $1',
	'sphinxClientFailed'       => 'فشل في بناء عرض زبون سفينكس.',
	'sphinxSearchFailed'       => ' إخفاق في السؤال: $1',
	'sphinxSearchWarning'      => 'تحذير: $1',
	'sphinxPspellError'        => 'إخفاق في تفعيل التوسيع pspell.'
);
...
$messages['he'] = array(
	...
	'sphinxSearchStats' => '* המחרוזת "$1" נמצאה {{PLURAL:$2|פעם אחת|$2 פעמים}} ב{{PLURAL:$3|מסמך אחד|־$3 מסמכים}}',
	'sphinxSearchStatsInfo' => "''ייתכן שהמספרים למעלה כוללים מסמכים שאינם מופיעים בגלל הגדרות החיפוש.''",
